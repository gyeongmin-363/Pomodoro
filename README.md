# 🚌🚆 포커스루트(Focus Route) – 당신의 집중 여정을 함께하는 버스/기차 뽀모도로 앱
...
### 1. 핵심 컨셉 및 테마 변경
- [x] 앱 테마를 버스/기차 (KTX 스타일)로 변경
- [x] 집중 세션 관련 용어 변경 (예: "운행 시작", "목적지 도착")

### 2. 시각화 방식 변경
- [x] 메인 화면 배경을 단색 또는 심플한 디자인으로 수정
- [x] 집중 세션 중 바퀴 굴러가는 GIF 애니메이션 추가
- [x] 집중 시작 버튼 클릭 시 티켓 뜯는 애니메이션 효과 추가
...
- [x] 앱 전체 색상을 파란색, 흰색, 회색 계열로 변경 (Color.kt, Theme.kt 등 수정)
